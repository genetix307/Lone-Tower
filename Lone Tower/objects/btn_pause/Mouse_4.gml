...
instance_create_depth(81,153,depth-10,btn_challenge).my_slot=0
instance_create_depth(81,223,depth-10,btn_challenge).my_slot=1
instance_create_depth(81,293,depth-10,btn_challenge).my_slot=2

instance_create_depth(98,400,depth-10,btn_set_colorscheme)
instance_create_depth(98,460,depth-10,btn_set_fastmode)
instance_create_depth(98,520,depth-10,btn_set_wagonmode)
instance_create_depth(98,580,depth-10,btn_effects)
...
instance_create_depth(85,820,depth-10,card_show_pause).my_slot=0
instance_create_depth(190,820,depth-10,card_show_pause).my_slot=1
instance_create_depth(295,820,depth-10,card_show_pause).my_slot=2
instance_create_depth(400,820,depth-10,card_show_pause).my_slot=3
