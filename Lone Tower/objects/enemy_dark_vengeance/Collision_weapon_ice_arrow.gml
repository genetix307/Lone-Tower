enemy_damaged("DarkVengeance", 0,1) //Slain Type, Log Name, Knockback On, Critical On
if 2 > random(95) {instance_create_depth(x-200,y-36,depth,enemy_skeleton)}
if 2 > random(95) {instance_create_depth(x-200,y+36,depth,enemy_skeleton)}
if 1 > random(95) {instance_create_depth(x-230,y+50,depth,enemy_armored_skeleton)}
if 1 > random(95) {instance_create_depth(x-230,y-50,depth,enemy_armored_skeleton)}
//frozen = 60
