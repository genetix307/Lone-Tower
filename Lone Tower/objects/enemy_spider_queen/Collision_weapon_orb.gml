...
instance_create_depth(x,y-8,depth,show_damage).myDamage = store.card_lvl_barrier*25+hud.perk_lvl_sideweapon
...
log_rotate(c_yellow,"Killed Spider Queen with Orb")
