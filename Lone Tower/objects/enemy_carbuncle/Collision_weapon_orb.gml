...
myHP -= store.card_lvl_orb*16
instance_create_depth(x,y-8,depth,show_damage).myDamage = store.card_lvl_orb*15
...
hud.enemies_slain +=1
store.carbuncles_slain +=1
log_rotate(c_yellow,"Killed Carbuncle with Orb")
instance_create_depth(x,y,depth-1,carbuncle_death)
