...
myHP -= store.card_lvl_orb*25+hud.perk_lvl_sideweapon+(hud.perk_lvl_bossslayer*5)
instance_create_depth(x,y-8,depth,show_damage).myDamage = store.card_lvl_orb*25+hud.perk_lvl_sideweapon+(hud.perk_lvl_bossslayer*5)
...
log_rotate(c_yellow,"Killed Dark Vengeance with Orb")
