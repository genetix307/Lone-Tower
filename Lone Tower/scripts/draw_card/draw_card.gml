...
draw_text_ext(x-43,y+8,"Start with "+calc_number((store.card_lvl_inheritance*25)+5)+" gold, and gain "+calc_number(store.card_lvl_inheritance*5)+" each day.",14,88)
draw_set_color(c_yellow)
...
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Every 4 days dig up "+calc_number(store.card_lvl_mineshaft+1)+" Gems.",14,88)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_mineshaft)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_farming),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Crops worth +"+calc_number(store.card_lvl_farming*15)+" Gold. Shrooms +"+calc_number(store.card_lvl_farming*3)+" Gold.",14,88)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_farming)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_barrier),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Creates spike barrier with "+calc_number(store.card_lvl_barrier*6)+" damage",14,88)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_barrier))
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_orb),15,86)
draw_set_color(c_white)
if store.card_lvl_orb < 2 {draw_text_ext(x-43,y+8,"Creates Orb that circles tower dealing "+calc_number(store.card_lvl_orb*25)+" damage.",14,88)}
if store.card_lvl_orb >= 2 {draw_text_ext(x-43,y+8,"Creates 2 Orbs that circle tower dealing "+calc_number(store.card_lvl_orb*25)+" damage.",14,88)}
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_orb))
...
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Earn "+calc_number((store.card_lvl_critgold*2)+3)+" Gold for each Critical Kill. Critical % +1",14,88)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_critgold)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_wind),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Slow down enemies inside of attack range by "+calc_number((store.card_lvl_wind*.25)+19.75)+"%",14,88)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_wind)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_rage),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Fury button puts Tower in Rage mode for "+calc_number((store.card_lvl_rage*2)+3)+" seconds.",14,88)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_rage))
...
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"If hit, make Shockwave that knocks back enemies and does "+calc_number(store.card_lvl_shockwave*8)+" damage.",11,88)
draw_set_font(font_stats)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_shockwave)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_supplydrop),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Supply Drops contain x"+calc_number(store.card_lvl_supplydrop+1)+" extra loot.",11,88)
draw_set_font(font_stats)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_supplydrop)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_axes),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Throw deadly Axes randomly that do "+calc_number((store.card_lvl_axes*15)+10)+" damage.",11,88)
draw_set_font(font_stats)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_axes)) 
...
draw_set_color(c_yellow)
draw_text_ext(x-43,y-4,"Level "+calc_number(store.card_lvl_evilcreed),15,86)
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"+"+calc_number(store.card_lvl_evilcreed+4)+" Gems daily, +"+calc_number(store.card_lvl_evilcreed*2)+" Enemy Level",11,88)
draw_set_font(font_stats)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_evilcreed)) 
...
draw_set_color(c_white)
draw_text_ext(x-43,y+8,calc_number((store.card_lvl_mastery*.25)+14.75)+"% chance enemies drop up to 3 extra XP Orbs.",11,88)
draw_set_font(font_stats)
draw_set_color(c_yellow)
draw_text(x+18,y+50,"x"+calc_number(store.card_mastery)) 
