...
total_choices=3.99 //UPDATE THIS WHEN ADDING NEW CHOICE
...
instance_create_depth(cx+146,cy+330,depth-10,btn_lvl_upgrade).my_id=slot_1
instance_create_depth(cx+146,cy+410,depth-10,btn_lvl_upgrade).my_id=slot_2
instance_create_depth(cx+146,cy+490,depth-10,btn_lvl_upgrade).my_id=slot_3
