...
if 5>random(100) and store.current_wave>15 {instance_create_depth(-32,444,depth,mushroom_wisdom)}
...
//Set Wind Speed
hud.wind_speed=round(3+random(17))
if hud.winter>0 {hud.wind_speed+=round(random(15))}
