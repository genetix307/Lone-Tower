...
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"Slow down enemies inside of attack range by "+string((store.card_lvl_wind*.5)+19.5)+"%",14,88)
draw_set_color(c_yellow)
...
draw_set_color(c_white)
draw_text_ext(x-43,y+8,"If hit, make Shockwave that knocks back enemies and does "+string(store.card_lvl_shockwave*10)+" damage.",11,88)
draw_set_font(font_stats)
draw_set_color(c_yellow)
