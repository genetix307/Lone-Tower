...
if store.vampirefang<1000 {draw_text(150,570,"Vampire Fang x"+string(store.vampirefang))} else {draw_text(150,530,"Vampire Fang x"+string((floor(store.vampirefang)/1000))+"K")}
