enemy_damaged("Tentacles", 0,1) //Slain Type, Log Name, Knockback On, Critical On
...
log_rotate(c_yellow,"Killed Tentacle BOSS")
...
//knockback
//mp_potential_step_object(tower.x,tower.y,-hud.knockback/10,default_solid)
*/